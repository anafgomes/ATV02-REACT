...
import logo from "../../../conbustivel.png"
...
const CombustivelCalculator = () => {
  ...
  const Calcular = () => {
    ...
    const calculo = parseFloat(precoEtanol.replace(',', '.')) / parseFloat(precoGasolina.replace(',', '.'));

    setResultado(calculo < 0.7 ? 'Etanol é mais vantajoso' : 'Gasolina é mais vantajosa');
  };
    ...
    <div className={styles.calculadoracontainer}>
      ...
      <div className={styles.inputscontainer}>
        <div>
          ...
          <br/>
          <input type="text" id="precoEtanol" value={precoEtanol} placeholder='0' onChange={(e) => setPrecoEtanol(e.target.value)}
          />
        </div>
        <div>
          <br/>
          ...
          <br/>
          <input type="text" id="precoGasolina" value={precoGasolina} placeholder='0' onChange={(e) => setPrecoGasolina(e.target.value)}
          />
          <br/>
          <br/>
